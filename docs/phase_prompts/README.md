...
**Status:** Phase 1 inventory complete; Phase 2-22 prompts pending
...
|---|---|---|---|
| 1 | `Guerilla-Kickoff-Prompt.md` | A | IN PROGRESS |
| 2 | `PHASE_02_ARCHITECTURE_DECISIONS.md` | A | PENDING (not yet created) |
